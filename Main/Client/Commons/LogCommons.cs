...
internal static partial class LogCommons
{
    ...
    [LoggerMessage(LogLevel.Debug, "{entityName}: {entity}")]
    public static partial void LogFormDataDebug(ILogger logger, string entityName, IEntity entity);

    [LoggerMessage(LogLevel.Debug, "{entityName} form submitted")]
    public static partial void LogFormSubmittedDebug(ILogger logger, string entityName);
    ...
    [LoggerMessage(LogLevel.Error, "{first}: {second}")]
    public static partial void LogPairError(ILogger logger, string first, string second);
