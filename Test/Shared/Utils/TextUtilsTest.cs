...
internal sealed class TextUtilsTest
{
    ...
    [TestCase("𱃹", ExpectedResult = 1, TestName = $"{nameof(TextUtilsTest)}.{nameof(GetStringRealLengthTest)} - single Chinese character - CJK extension G")]
    ...
    [TestCase("𱃹", ExpectedResult = true, TestName = $"{nameof(TextUtilsTest)}.{nameof(IsOnlyChineseCharactersTest)} - single Chinese character - CJK extension G")]
